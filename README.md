...
It is a complete online shopping platform where users can browse products, add them to cart, and place orders.  This is similar to real platforms like Amazon or Flipkart. Using html , css , script.js and javascript
